<?php
/**
 * ComHivextApiServerUsersResponseCollaborationResourceResponses
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ComHivextApiServerUsersResponseCollaborationResourceResponses Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ComHivextApiServerUsersResponseCollaborationResourceResponses implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'com.hivext.api.server.users.response.CollaborationResourceResponses';
    ...
    */
    ...
    public function setError($error)
    {
        if (!is_null($error) && (mb_strlen($error) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $error when calling ComHivextApiServerUsersResponseCollaborationResourceResponses., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($error) && (!preg_match("/(.*){0,2147483647}/", $error))) {
            throw new \InvalidArgumentException("invalid value for \$error when calling ComHivextApiServerUsersResponseCollaborationResourceResponses., must conform to the pattern /(.*){0,2147483647}/.");
        }
    ...
    public function setReason($reason)
    {
        ...
        if (!is_null($reason) && ($reason > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $reason when calling ComHivextApiServerUsersResponseCollaborationResourceResponses., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($reason) && ($reason < -2147483648)) {
            throw new \InvalidArgumentException('invalid value for $reason when calling ComHivextApiServerUsersResponseCollaborationResourceResponses., must be bigger than or equal to -2147483648.');
        }
    ...
    public function setResponses($responses)
    {
        ...
        if (!is_null($responses) && (count($responses) > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $responses when calling ComHivextApiServerUsersResponseCollaborationResourceResponses., number of items must be less than or equal to 2147483647.');
        }
    ...
    public function setResult($result)
    {
        ...
        if (!is_null($result) && ($result > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $result when calling ComHivextApiServerUsersResponseCollaborationResourceResponses., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($result) && ($result < -2147483648)) {
            throw new \InvalidArgumentException('invalid value for $result when calling ComHivextApiServerUsersResponseCollaborationResourceResponses., must be bigger than or equal to -2147483648.');
        }
    ...
    public function setSource($source)
    {
        if (!is_null($source) && (mb_strlen($source) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $source when calling ComHivextApiServerUsersResponseCollaborationResourceResponses., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($source) && (!preg_match("/(.*){0,2147483647}/", $source))) {
            throw new \InvalidArgumentException("invalid value for \$source when calling ComHivextApiServerUsersResponseCollaborationResourceResponses., must conform to the pattern /(.*){0,2147483647}/.");
        }

...
/**
 * CollaborationRoleOwner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CollaborationRoleOwner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CollaborationRole_owner';
    ...
    protected static $openAPITypes = [
        'phoneNumber' => 'string',
        'authConfig' => '\OpenAPI\Client\Model\ComHivextApiServerUsersResponseAuthenticationResponseRequiredAuthCheck',
        'name' => 'string',
        'externalId' => 'string',
        'id' => 'int',
        'authType' => 'string',
    ...
    */
    ...
    public function setPhoneNumber($phoneNumber)
    {
        if (!is_null($phoneNumber) && (mb_strlen($phoneNumber) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $phoneNumber when calling CollaborationRoleOwner., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($phoneNumber) && (!preg_match("/(.*){0,2147483647}/", $phoneNumber))) {
            throw new \InvalidArgumentException("invalid value for \$phoneNumber when calling CollaborationRoleOwner., must conform to the pattern /(.*){0,2147483647}/.");
        }
     ...
     * Sets authConfig
     *
     * @param \OpenAPI\Client\Model\ComHivextApiServerUsersResponseAuthenticationResponseRequiredAuthCheck|null $authConfig authConfig
     *
     * @return self
     */
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CollaborationRoleOwner., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($name) && (!preg_match("/(.*){0,2147483647}/", $name))) {
            throw new \InvalidArgumentException("invalid value for \$name when calling CollaborationRoleOwner., must conform to the pattern /(.*){0,2147483647}/.");
        }
    ...
    public function setExternalId($externalId)
    {
        if (!is_null($externalId) && (mb_strlen($externalId) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $externalId when calling CollaborationRoleOwner., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($externalId) && (!preg_match("/(.*){0,2147483647}/", $externalId))) {
            throw new \InvalidArgumentException("invalid value for \$externalId when calling CollaborationRoleOwner., must conform to the pattern /(.*){0,2147483647}/.");
        }
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && ($id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $id when calling CollaborationRoleOwner., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($id) && ($id < -2147483648)) {
            throw new \InvalidArgumentException('invalid value for $id when calling CollaborationRoleOwner., must be bigger than or equal to -2147483648.');
        }
    ...
    public function setEmail($email)
    {
        if (!is_null($email) && (mb_strlen($email) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $email when calling CollaborationRoleOwner., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($email) && (!preg_match("/(.*){0,2147483647}/", $email))) {
            throw new \InvalidArgumentException("invalid value for \$email when calling CollaborationRoleOwner., must conform to the pattern /(.*){0,2147483647}/.");
        }

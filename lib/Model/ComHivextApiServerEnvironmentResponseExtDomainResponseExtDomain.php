<?php
/**
 * ComHivextApiServerEnvironmentResponseExtDomainResponseExtDomain
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ComHivextApiServerEnvironmentResponseExtDomainResponseExtDomain Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ComHivextApiServerEnvironmentResponseExtDomainResponseExtDomain implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'com_hivext_api_server_environment_response_ExtDomainResponse_extDomain';
    ...
    */
    ...
    public function setDomain($domain)
    {
        if (!is_null($domain) && (mb_strlen($domain) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $domain when calling ComHivextApiServerEnvironmentResponseExtDomainResponseExtDomain., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($domain) && (!preg_match("/(.*){0,2147483647}/", $domain))) {
            throw new \InvalidArgumentException("invalid value for \$domain when calling ComHivextApiServerEnvironmentResponseExtDomainResponseExtDomain., must conform to the pattern /(.*){0,2147483647}/.");
        }
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && ($id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $id when calling ComHivextApiServerEnvironmentResponseExtDomainResponseExtDomain., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($id) && ($id < -2147483648)) {
            throw new \InvalidArgumentException('invalid value for $id when calling ComHivextApiServerEnvironmentResponseExtDomainResponseExtDomain., must be bigger than or equal to -2147483648.');
        }

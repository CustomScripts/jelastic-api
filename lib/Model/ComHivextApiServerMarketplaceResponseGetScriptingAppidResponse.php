...
/**
 * ComHivextApiServerMarketplaceResponseGetScriptingAppidResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ComHivextApiServerMarketplaceResponseGetScriptingAppidResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'com.hivext.api.server.marketplace.response.GetScriptingAppidResponse';
    ...
    */
    ...
    public function setAppid($appid)
    {
        if (!is_null($appid) && (mb_strlen($appid) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $appid when calling ComHivextApiServerMarketplaceResponseGetScriptingAppidResponse., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($appid) && (!preg_match("/(.*){0,2147483647}/", $appid))) {
            throw new \InvalidArgumentException("invalid value for \$appid when calling ComHivextApiServerMarketplaceResponseGetScriptingAppidResponse., must conform to the pattern /(.*){0,2147483647}/.");
        }
    ...
    public function setError($error)
    {
        if (!is_null($error) && (mb_strlen($error) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $error when calling ComHivextApiServerMarketplaceResponseGetScriptingAppidResponse., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($error) && (!preg_match("/(.*){0,2147483647}/", $error))) {
            throw new \InvalidArgumentException("invalid value for \$error when calling ComHivextApiServerMarketplaceResponseGetScriptingAppidResponse., must conform to the pattern /(.*){0,2147483647}/.");
        }
    ...
    public function setResult($result)
    {
        ...
        if (!is_null($result) && ($result > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $result when calling ComHivextApiServerMarketplaceResponseGetScriptingAppidResponse., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($result) && ($result < -2147483648)) {
            throw new \InvalidArgumentException('invalid value for $result when calling ComHivextApiServerMarketplaceResponseGetScriptingAppidResponse., must be bigger than or equal to -2147483648.');
        }

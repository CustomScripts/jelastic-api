    ...
    */
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $description when calling Quota., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($description) && (!preg_match("/(.*){0,2147483647}/", $description))) {
            throw new \InvalidArgumentException("invalid value for \$description when calling Quota., must conform to the pattern /(.*){0,2147483647}/.");
        }
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Quota., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($name) && (!preg_match("/(.*){0,2147483647}/", $name))) {
            throw new \InvalidArgumentException("invalid value for \$name when calling Quota., must conform to the pattern /(.*){0,2147483647}/.");
        }
    ...
    public function setReferenceId($referenceId)
    {
        if (!is_null($referenceId) && (mb_strlen($referenceId) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $referenceId when calling Quota., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($referenceId) && (!preg_match("/(.*){0,2147483647}/", $referenceId))) {
            throw new \InvalidArgumentException("invalid value for \$referenceId when calling Quota., must conform to the pattern /(.*){0,2147483647}/.");
        }

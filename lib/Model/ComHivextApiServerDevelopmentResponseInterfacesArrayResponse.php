...
/**
 * ComHivextApiServerDevelopmentResponseInterfacesArrayResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ComHivextApiServerDevelopmentResponseInterfacesArrayResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'com.hivext.api.server.development.response.interfaces.ArrayResponse';
    ...
    */
    ...
    public function setArray($array)
    {
        ...
        if (!is_null($array) && (count($array) > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $array when calling ComHivextApiServerDevelopmentResponseInterfacesArrayResponse., number of items must be less than or equal to 2147483647.');
        }
    ...
    public function setClassName($className)
    {
        if (!is_null($className) && (mb_strlen($className) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $className when calling ComHivextApiServerDevelopmentResponseInterfacesArrayResponse., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($className) && (!preg_match("/(.*){0,2147483647}/", $className))) {
            throw new \InvalidArgumentException("invalid value for \$className when calling ComHivextApiServerDevelopmentResponseInterfacesArrayResponse., must conform to the pattern /(.*){0,2147483647}/.");
        }
    ...
    public function setError($error)
    {
        if (!is_null($error) && (mb_strlen($error) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $error when calling ComHivextApiServerDevelopmentResponseInterfacesArrayResponse., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($error) && (!preg_match("/(.*){0,2147483647}/", $error))) {
            throw new \InvalidArgumentException("invalid value for \$error when calling ComHivextApiServerDevelopmentResponseInterfacesArrayResponse., must conform to the pattern /(.*){0,2147483647}/.");
        }
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ComHivextApiServerDevelopmentResponseInterfacesArrayResponse., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($name) && (!preg_match("/(.*){0,2147483647}/", $name))) {
            throw new \InvalidArgumentException("invalid value for \$name when calling ComHivextApiServerDevelopmentResponseInterfacesArrayResponse., must conform to the pattern /(.*){0,2147483647}/.");
        }
    ...
    public function setReason($reason)
    {
        ...
        if (!is_null($reason) && ($reason > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $reason when calling ComHivextApiServerDevelopmentResponseInterfacesArrayResponse., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($reason) && ($reason < -2147483648)) {
            throw new \InvalidArgumentException('invalid value for $reason when calling ComHivextApiServerDevelopmentResponseInterfacesArrayResponse., must be bigger than or equal to -2147483648.');
        }
    ...
    public function setResult($result)
    {
        ...
        if (!is_null($result) && ($result > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $result when calling ComHivextApiServerDevelopmentResponseInterfacesArrayResponse., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($result) && ($result < -2147483648)) {
            throw new \InvalidArgumentException('invalid value for $result when calling ComHivextApiServerDevelopmentResponseInterfacesArrayResponse., must be bigger than or equal to -2147483648.');
        }
    ...
    public function setSource($source)
    {
        if (!is_null($source) && (mb_strlen($source) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $source when calling ComHivextApiServerDevelopmentResponseInterfacesArrayResponse., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($source) && (!preg_match("/(.*){0,2147483647}/", $source))) {
            throw new \InvalidArgumentException("invalid value for \$source when calling ComHivextApiServerDevelopmentResponseInterfacesArrayResponse., must conform to the pattern /(.*){0,2147483647}/.");
        }

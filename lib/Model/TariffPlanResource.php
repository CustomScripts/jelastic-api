...
/**
 * TariffPlanResource Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TariffPlanResource implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TariffPlan_resource';
    ...
    public const UNIT_UNIT_0 = 'UNIT(0)';
    public const UNIT_MB_1 = 'MB(1)';
    public const UNIT_MBPS_2 = 'MBPS(2)';
    public const UNIT_MHZ_3 = 'MHZ(3)';
    public const UNIT_HOUR_4 = 'HOUR(4)';
    public const UNIT_MIB_5 = 'MIB(5)';
    public const UNIT_MIBPS_6 = 'MIBPS(6)';
    public const UNIT_GB_7 = 'GB(7)';
    public const TYPE_DEFAULT_0 = 'DEFAULT(0)';
    public const TYPE_EXTERNAL_1 = 'EXTERNAL(1)';
    public const TYPE_CUSTOM_2 = 'CUSTOM(2)';
    ...
    */
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $name when calling TariffPlanResource., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($name) && (!preg_match("/(.*){0,2147483647}/", $name))) {
            throw new \InvalidArgumentException("invalid value for \$name when calling TariffPlanResource., must conform to the pattern /(.*){0,2147483647}/.");
        }
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $description when calling TariffPlanResource., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($description) && (!preg_match("/(.*){0,2147483647}/", $description))) {
            throw new \InvalidArgumentException("invalid value for \$description when calling TariffPlanResource., must conform to the pattern /(.*){0,2147483647}/.");
        }

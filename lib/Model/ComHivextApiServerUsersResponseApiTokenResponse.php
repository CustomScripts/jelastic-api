<?php
/**
 * ComHivextApiServerUsersResponseApiTokenResponse
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ComHivextApiServerUsersResponseApiTokenResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ComHivextApiServerUsersResponseApiTokenResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'com.hivext.api.server.users.response.ApiTokenResponse';
    ...
    protected static $openAPITypes = [
        ...
        'result' => 'int',
        'source' => 'string',
        'token' => '\OpenAPI\Client\Model\ComHivextApiServerUsersResponseApiTokenResponseToken'
    ];
    ...
    */
    ...
    public function setError($error)
    {
        if (!is_null($error) && (mb_strlen($error) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $error when calling ComHivextApiServerUsersResponseApiTokenResponse., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($error) && (!preg_match("/(.*){0,2147483647}/", $error))) {
            throw new \InvalidArgumentException("invalid value for \$error when calling ComHivextApiServerUsersResponseApiTokenResponse., must conform to the pattern /(.*){0,2147483647}/.");
        }
    ...
    public function setReason($reason)
    {
        ...
        if (!is_null($reason) && ($reason > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $reason when calling ComHivextApiServerUsersResponseApiTokenResponse., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($reason) && ($reason < -2147483648)) {
            throw new \InvalidArgumentException('invalid value for $reason when calling ComHivextApiServerUsersResponseApiTokenResponse., must be bigger than or equal to -2147483648.');
        }
    ...
    public function setResult($result)
    {
        ...
        if (!is_null($result) && ($result > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $result when calling ComHivextApiServerUsersResponseApiTokenResponse., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($result) && ($result < -2147483648)) {
            throw new \InvalidArgumentException('invalid value for $result when calling ComHivextApiServerUsersResponseApiTokenResponse., must be bigger than or equal to -2147483648.');
        }
    ...
    public function setSource($source)
    {
        if (!is_null($source) && (mb_strlen($source) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $source when calling ComHivextApiServerUsersResponseApiTokenResponse., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($source) && (!preg_match("/(.*){0,2147483647}/", $source))) {
            throw new \InvalidArgumentException("invalid value for \$source when calling ComHivextApiServerUsersResponseApiTokenResponse., must conform to the pattern /(.*){0,2147483647}/.");
        }
     ...
     * Gets token
     *
     * @return \OpenAPI\Client\Model\ComHivextApiServerUsersResponseApiTokenResponseToken|null
     */
     ...
     * Sets token
     *
     * @param \OpenAPI\Client\Model\ComHivextApiServerUsersResponseApiTokenResponseToken|null $token token
     *
     * @return self
     */

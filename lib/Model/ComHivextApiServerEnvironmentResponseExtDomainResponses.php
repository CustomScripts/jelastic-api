...
/**
 * ComHivextApiServerEnvironmentResponseExtDomainResponses Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ComHivextApiServerEnvironmentResponseExtDomainResponses implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'com.hivext.api.server.environment.response.ExtDomainResponses';
    ...
    */
    ...
    public function setError($error)
    {
        if (!is_null($error) && (mb_strlen($error) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $error when calling ComHivextApiServerEnvironmentResponseExtDomainResponses., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($error) && (!preg_match("/(.*){0,2147483647}/", $error))) {
            throw new \InvalidArgumentException("invalid value for \$error when calling ComHivextApiServerEnvironmentResponseExtDomainResponses., must conform to the pattern /(.*){0,2147483647}/.");
        }
    ...
    public function setExtDomains($extDomains)
    {
        ...
        if (!is_null($extDomains) && (count($extDomains) > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $extDomains when calling ComHivextApiServerEnvironmentResponseExtDomainResponses., number of items must be less than or equal to 2147483647.');
        }
    ...
    public function setReason($reason)
    {
        ...
        if (!is_null($reason) && ($reason > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $reason when calling ComHivextApiServerEnvironmentResponseExtDomainResponses., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($reason) && ($reason < -2147483648)) {
            throw new \InvalidArgumentException('invalid value for $reason when calling ComHivextApiServerEnvironmentResponseExtDomainResponses., must be bigger than or equal to -2147483648.');
        }
    ...
    public function setResult($result)
    {
        ...
        if (!is_null($result) && ($result > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $result when calling ComHivextApiServerEnvironmentResponseExtDomainResponses., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($result) && ($result < -2147483648)) {
            throw new \InvalidArgumentException('invalid value for $result when calling ComHivextApiServerEnvironmentResponseExtDomainResponses., must be bigger than or equal to -2147483648.');
        }
    ...
    public function setSource($source)
    {
        if (!is_null($source) && (mb_strlen($source) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $source when calling ComHivextApiServerEnvironmentResponseExtDomainResponses., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($source) && (!preg_match("/(.*){0,2147483647}/", $source))) {
            throw new \InvalidArgumentException("invalid value for \$source when calling ComHivextApiServerEnvironmentResponseExtDomainResponses., must conform to the pattern /(.*){0,2147483647}/.");
        }

...
/**
 * ComHivextApiServerUsersResponseApiTokenResponseTokenTokenTemplate Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ComHivextApiServerUsersResponseApiTokenResponseTokenTokenTemplate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'com_hivext_api_server_users_response_ApiTokenResponse_token_tokenTemplate';
    ...
    */
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ComHivextApiServerUsersResponseApiTokenResponseTokenTokenTemplate., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($name) && (!preg_match("/(.*){0,2147483647}/", $name))) {
            throw new \InvalidArgumentException("invalid value for \$name when calling ComHivextApiServerUsersResponseApiTokenResponseTokenTokenTemplate., must conform to the pattern /(.*){0,2147483647}/.");
        }
    ...
    public function setApiListItems($apiListItems)
    {
        ...
        if (!is_null($apiListItems) && (count($apiListItems) > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $apiListItems when calling ComHivextApiServerUsersResponseApiTokenResponseTokenTokenTemplate., number of items must be less than or equal to 2147483647.');
        }
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && ($id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $id when calling ComHivextApiServerUsersResponseApiTokenResponseTokenTokenTemplate., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($id) && ($id < -2147483648)) {
            throw new \InvalidArgumentException('invalid value for $id when calling ComHivextApiServerUsersResponseApiTokenResponseTokenTokenTemplate., must be bigger than or equal to -2147483648.');
        }

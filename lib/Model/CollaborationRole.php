...
/**
 * CollaborationRole Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CollaborationRole implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CollaborationRole';
    ...
    */
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CollaborationRole., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($description) && (!preg_match("/(.*){0,2147483647}/", $description))) {
            throw new \InvalidArgumentException("invalid value for \$description when calling CollaborationRole., must conform to the pattern /(.*){0,2147483647}/.");
        }
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && ($id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $id when calling CollaborationRole., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($id) && ($id < -2147483648)) {
            throw new \InvalidArgumentException('invalid value for $id when calling CollaborationRole., must be bigger than or equal to -2147483648.');
        }
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CollaborationRole., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($name) && (!preg_match("/(.*){0,2147483647}/", $name))) {
            throw new \InvalidArgumentException("invalid value for \$name when calling CollaborationRole., must conform to the pattern /(.*){0,2147483647}/.");
        }
    ...
    public function setPolicies($policies)
    {
        ...
        if (!is_null($policies) && (count($policies) > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $policies when calling CollaborationRole., number of items must be less than or equal to 2147483647.');
        }

<?php
/**
 * ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodePrimaryIpv4
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodePrimaryIpv4 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodePrimaryIpv4 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'com_hivext_api_server_environment_response_SoftwareNodeResponse_softNode_primaryIpv4';
    ...
    protected static $openAPITypes = [
        'isBusy' => 'bool',
        'regionUniqueNames' => '\OpenAPI\Client\Model\Region[]',
        'appid' => 'string',
        'domain' => 'string',
        'ipAddress' => 'string',
        'type' => 'string'
    ...
    */
     ...
     *
     * @param \OpenAPI\Client\Model\Region[]|null $regionUniqueNames regionUniqueNames
     *
     * @return self
     */
    public function setRegionUniqueNames($regionUniqueNames)
    {
        ...
        if (!is_null($regionUniqueNames) && (count($regionUniqueNames) > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $regionUniqueNames when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodePrimaryIpv4., number of items must be less than or equal to 2147483647.');
        }
    ...
    public function setAppid($appid)
    {
        if (!is_null($appid) && (mb_strlen($appid) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $appid when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodePrimaryIpv4., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($appid) && (!preg_match("/(.*){0,2147483647}/", $appid))) {
            throw new \InvalidArgumentException("invalid value for \$appid when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodePrimaryIpv4., must conform to the pattern /(.*){0,2147483647}/.");
        }
    ...
    public function setDomain($domain)
    {
        if (!is_null($domain) && (mb_strlen($domain) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $domain when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodePrimaryIpv4., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($domain) && (!preg_match("/(.*){0,2147483647}/", $domain))) {
            throw new \InvalidArgumentException("invalid value for \$domain when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodePrimaryIpv4., must conform to the pattern /(.*){0,2147483647}/.");
        }
    ...
    public function setIpAddress($ipAddress)
    {
        if (!is_null($ipAddress) && (mb_strlen($ipAddress) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $ipAddress when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodePrimaryIpv4., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($ipAddress) && (!preg_match("/(.*){0,2147483647}/", $ipAddress))) {
            throw new \InvalidArgumentException("invalid value for \$ipAddress when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodePrimaryIpv4., must conform to the pattern /(.*){0,2147483647}/.");
        }

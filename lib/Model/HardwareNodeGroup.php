...
/**
 * HardwareNodeGroup Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class HardwareNodeGroup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HardwareNodeGroup';
    ...
    */
    ...
    public function setComment($comment)
    {
        if (!is_null($comment) && (mb_strlen($comment) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling HardwareNodeGroup., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($comment) && (!preg_match("/(.*){0,2147483647}/", $comment))) {
            throw new \InvalidArgumentException("invalid value for \$comment when calling HardwareNodeGroup., must conform to the pattern /(.*){0,2147483647}/.");
        }
    ...
    public function setData($data)
    {
        if (!is_null($data) && (mb_strlen($data) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $data when calling HardwareNodeGroup., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($data) && (!preg_match("/(.*){0,2147483647}/", $data))) {
            throw new \InvalidArgumentException("invalid value for \$data when calling HardwareNodeGroup., must conform to the pattern /(.*){0,2147483647}/.");
        }
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $description when calling HardwareNodeGroup., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($description) && (!preg_match("/(.*){0,2147483647}/", $description))) {
            throw new \InvalidArgumentException("invalid value for \$description when calling HardwareNodeGroup., must conform to the pattern /(.*){0,2147483647}/.");
        }
    ...
    public function setDisplayName($displayName)
    {
        if (!is_null($displayName) && (mb_strlen($displayName) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $displayName when calling HardwareNodeGroup., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($displayName) && (!preg_match("/(.*){0,2147483647}/", $displayName))) {
            throw new \InvalidArgumentException("invalid value for \$displayName when calling HardwareNodeGroup., must conform to the pattern /(.*){0,2147483647}/.");
        }
    ...
    public function setEndpoints($endpoints)
    {
        ...
        if (!is_null($endpoints) && (count($endpoints) > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $endpoints when calling HardwareNodeGroup., number of items must be less than or equal to 2147483647.');
        }
    ...
    public function setIconsData($iconsData)
    {
        if (!is_null($iconsData) && (mb_strlen($iconsData) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $iconsData when calling HardwareNodeGroup., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($iconsData) && (!preg_match("/(.*){0,2147483647}/", $iconsData))) {
            throw new \InvalidArgumentException("invalid value for \$iconsData when calling HardwareNodeGroup., must conform to the pattern /(.*){0,2147483647}/.");
        }
    ...
    public function setL3Group($l3Group)
    {
        if (!is_null($l3Group) && (mb_strlen($l3Group) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $l3Group when calling HardwareNodeGroup., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($l3Group) && (!preg_match("/(.*){0,2147483647}/", $l3Group))) {
            throw new \InvalidArgumentException("invalid value for \$l3Group when calling HardwareNodeGroup., must conform to the pattern /(.*){0,2147483647}/.");
        }
    ...
    public function setMetadata($metadata)
    {
        if (!is_null($metadata) && (mb_strlen($metadata) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $metadata when calling HardwareNodeGroup., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($metadata) && (!preg_match("/(.*){0,2147483647}/", $metadata))) {
            throw new \InvalidArgumentException("invalid value for \$metadata when calling HardwareNodeGroup., must conform to the pattern /(.*){0,2147483647}/.");
        }
    ...
    public function setOsTypes($osTypes)
    {
        ...
        if (!is_null($osTypes) && (count($osTypes) > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $osTypes when calling HardwareNodeGroup., number of items must be less than or equal to 2147483647.');
        }
    ...
    public function setRegionUniqueName($regionUniqueName)
    {
        if (!is_null($regionUniqueName) && (mb_strlen($regionUniqueName) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $regionUniqueName when calling HardwareNodeGroup., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($regionUniqueName) && (!preg_match("/(.*){0,2147483647}/", $regionUniqueName))) {
            throw new \InvalidArgumentException("invalid value for \$regionUniqueName when calling HardwareNodeGroup., must conform to the pattern /(.*){0,2147483647}/.");
        }
    ...
    public function setShortDescription($shortDescription)
    {
        if (!is_null($shortDescription) && (mb_strlen($shortDescription) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $shortDescription when calling HardwareNodeGroup., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($shortDescription) && (!preg_match("/(.*){0,2147483647}/", $shortDescription))) {
            throw new \InvalidArgumentException("invalid value for \$shortDescription when calling HardwareNodeGroup., must conform to the pattern /(.*){0,2147483647}/.");
        }
    ...
    public function setUniqueName($uniqueName)
    {
        if (!is_null($uniqueName) && (mb_strlen($uniqueName) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $uniqueName when calling HardwareNodeGroup., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($uniqueName) && (!preg_match("/(.*){0,2147483647}/", $uniqueName))) {
            throw new \InvalidArgumentException("invalid value for \$uniqueName when calling HardwareNodeGroup., must conform to the pattern /(.*){0,2147483647}/.");
        }
    ...
    public function setVTypes($vTypes)
    {
        ...
        if (!is_null($vTypes) && (count($vTypes) > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $vTypes when calling HardwareNodeGroup., number of items must be less than or equal to 2147483647.');
        }
    ...
    public function setVzType($vzType)
    {
        ...
        if (!is_null($vzType) && ($vzType > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $vzType when calling HardwareNodeGroup., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($vzType) && ($vzType < -2147483648)) {
            throw new \InvalidArgumentException('invalid value for $vzType when calling HardwareNodeGroup., must be bigger than or equal to -2147483648.');
        }
    ...
    public function setVzTypes($vzTypes)
    {
        ...
        if (!is_null($vzTypes) && (count($vzTypes) > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $vzTypes when calling HardwareNodeGroup., number of items must be less than or equal to 2147483647.');
        }

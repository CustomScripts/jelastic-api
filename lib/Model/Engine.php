 ...
 */
class Engine implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Engine';
    ...
    */
    ...
    public function setKeyword($keyword)
    {
        if (!is_null($keyword) && (mb_strlen($keyword) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $keyword when calling Engine., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($keyword) && (!preg_match("/(.*){0,2147483647}/", $keyword))) {
            throw new \InvalidArgumentException("invalid value for \$keyword when calling Engine., must conform to the pattern /(.*){0,2147483647}/.");
        }
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Engine., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($name) && (!preg_match("/(.*){0,2147483647}/", $name))) {
            throw new \InvalidArgumentException("invalid value for \$name when calling Engine., must conform to the pattern /(.*){0,2147483647}/.");
        }
    ...
    public function setPackageName($packageName)
    {
        if (!is_null($packageName) && (mb_strlen($packageName) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $packageName when calling Engine., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($packageName) && (!preg_match("/(.*){0,2147483647}/", $packageName))) {
            throw new \InvalidArgumentException("invalid value for \$packageName when calling Engine., must conform to the pattern /(.*){0,2147483647}/.");
        }
    ...
    public function setType($type)
    {
        if (!is_null($type) && (mb_strlen($type) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $type when calling Engine., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($type) && (!preg_match("/(.*){0,2147483647}/", $type))) {
            throw new \InvalidArgumentException("invalid value for \$type when calling Engine., must conform to the pattern /(.*){0,2147483647}/.");
        }
    ...
    public function setVersion($version)
    {
        if (!is_null($version) && (mb_strlen($version) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $version when calling Engine., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($version) && (!preg_match("/(.*){0,2147483647}/", $version))) {
            throw new \InvalidArgumentException("invalid value for \$version when calling Engine., must conform to the pattern /(.*){0,2147483647}/.");
        }

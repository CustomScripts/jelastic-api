...
/**
 * ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHn Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHn implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'com_hivext_api_server_environment_response_SoftwareNodeResponse_softNode_hn';
    ...
    protected static $openAPITypes = [
        ...
        'hostname' => 'string',
        'osType' => 'string',
        'sshCredential' => '\OpenAPI\Client\Model\Credential',
        'l2Ready' => 'bool',
        'power' => 'int',
        ...
        'ipsecKey' => 'string',
        'vzType' => 'int',
        'soapCredential' => '\OpenAPI\Client\Model\LabelHardwareNodeSshCredential',
        'ipAddress' => 'string',
        'physCpuNumber' => 'int',
        'loadMarkOffset' => 'int',
        'labels' => 'object[]',
        ...
        'vsVersion' => '\OpenAPI\Client\Model\ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHnVsVersion',
        'l2Ip' => 'string',
        'externalIp' => 'string',
        'soapPort' => 'int',
        'status' => 'string'
    ...
    */
    ...
    public function setData($data)
    {
        if (!is_null($data) && (mb_strlen($data) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $data when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHn., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($data) && (!preg_match("/(.*){0,2147483647}/", $data))) {
            throw new \InvalidArgumentException("invalid value for \$data when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHn., must conform to the pattern /(.*){0,2147483647}/.");
        }
    ...
    public function setTcpProtocol($tcpProtocol)
    {
        if (!is_null($tcpProtocol) && (mb_strlen($tcpProtocol) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $tcpProtocol when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHn., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($tcpProtocol) && (!preg_match("/(.*){0,2147483647}/", $tcpProtocol))) {
            throw new \InvalidArgumentException("invalid value for \$tcpProtocol when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHn., must conform to the pattern /(.*){0,2147483647}/.");
        }
    ...
    public function setPreviousL2Ip($previousL2Ip)
    {
        if (!is_null($previousL2Ip) && (mb_strlen($previousL2Ip) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $previousL2Ip when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHn., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($previousL2Ip) && (!preg_match("/(.*){0,2147483647}/", $previousL2Ip))) {
            throw new \InvalidArgumentException("invalid value for \$previousL2Ip when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHn., must conform to the pattern /(.*){0,2147483647}/.");
        }
    ...
    public function setVirtualNetworkHostIds($virtualNetworkHostIds)
    {
        ...
        if (!is_null($virtualNetworkHostIds) && (count($virtualNetworkHostIds) > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $virtualNetworkHostIds when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHn., number of items must be less than or equal to 2147483647.');
        }
    ...
    public function setVirtualNetIp($virtualNetIp)
    {
        if (!is_null($virtualNetIp) && (mb_strlen($virtualNetIp) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $virtualNetIp when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHn., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($virtualNetIp) && (!preg_match("/(.*){0,2147483647}/", $virtualNetIp))) {
            throw new \InvalidArgumentException("invalid value for \$virtualNetIp when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHn., must conform to the pattern /(.*){0,2147483647}/.");
        }
    ...
    public function setTcpPort($tcpPort)
    {
        ...
        if (!is_null($tcpPort) && ($tcpPort > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $tcpPort when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHn., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($tcpPort) && ($tcpPort < -2147483648)) {
            throw new \InvalidArgumentException('invalid value for $tcpPort when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHn., must be bigger than or equal to -2147483648.');
        }
    ...
    public function setRealExternalIp($realExternalIp)
    {
        if (!is_null($realExternalIp) && (mb_strlen($realExternalIp) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $realExternalIp when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHn., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($realExternalIp) && (!preg_match("/(.*){0,2147483647}/", $realExternalIp))) {
            throw new \InvalidArgumentException("invalid value for \$realExternalIp when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHn., must conform to the pattern /(.*){0,2147483647}/.");
        }
    ...
    public function setHostname($hostname)
    {
        if (!is_null($hostname) && (mb_strlen($hostname) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $hostname when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHn., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($hostname) && (!preg_match("/(.*){0,2147483647}/", $hostname))) {
            throw new \InvalidArgumentException("invalid value for \$hostname when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHn., must conform to the pattern /(.*){0,2147483647}/.");
        }
     ...
     * Sets sshCredential
     *
     * @param \OpenAPI\Client\Model\Credential|null $sshCredential sshCredential
     *
     * @return self
     */
    ...
    public function setPower($power)
    {
        ...
        if (!is_null($power) && ($power > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $power when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHn., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($power) && ($power < -2147483648)) {
            throw new \InvalidArgumentException('invalid value for $power when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHn., must be bigger than or equal to -2147483648.');
        }
    ...
    public function setHardwareNodeGroup($hardwareNodeGroup)
    {
        if (!is_null($hardwareNodeGroup) && (mb_strlen($hardwareNodeGroup) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $hardwareNodeGroup when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHn., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($hardwareNodeGroup) && (!preg_match("/(.*){0,2147483647}/", $hardwareNodeGroup))) {
            throw new \InvalidArgumentException("invalid value for \$hardwareNodeGroup when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHn., must conform to the pattern /(.*){0,2147483647}/.");
        }
    ...
    public function setCpuNumber($cpuNumber)
    {
        ...
        if (!is_null($cpuNumber) && ($cpuNumber > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $cpuNumber when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHn., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($cpuNumber) && ($cpuNumber < -2147483648)) {
            throw new \InvalidArgumentException('invalid value for $cpuNumber when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHn., must be bigger than or equal to -2147483648.');
        }
    ...
    public function setSshPort($sshPort)
    {
        ...
        if (!is_null($sshPort) && ($sshPort > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $sshPort when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHn., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($sshPort) && ($sshPort < -2147483648)) {
            throw new \InvalidArgumentException('invalid value for $sshPort when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHn., must be bigger than or equal to -2147483648.');
        }
    ...
    public function setHardwareNodeClusters($hardwareNodeClusters)
    {
        ...
        if (!is_null($hardwareNodeClusters) && (count($hardwareNodeClusters) > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $hardwareNodeClusters when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHn., number of items must be less than or equal to 2147483647.');
        }
    ...
    public function setSoapProtocol($soapProtocol)
    {
        if (!is_null($soapProtocol) && (mb_strlen($soapProtocol) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $soapProtocol when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHn., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($soapProtocol) && (!preg_match("/(.*){0,2147483647}/", $soapProtocol))) {
            throw new \InvalidArgumentException("invalid value for \$soapProtocol when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHn., must conform to the pattern /(.*){0,2147483647}/.");
        }
    ...
    public function setIpsecKey($ipsecKey)
    {
        if (!is_null($ipsecKey) && (mb_strlen($ipsecKey) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $ipsecKey when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHn., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($ipsecKey) && (!preg_match("/(.*){0,2147483647}/", $ipsecKey))) {
            throw new \InvalidArgumentException("invalid value for \$ipsecKey when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHn., must conform to the pattern /(.*){0,2147483647}/.");
        }
    ...
    public function setVzType($vzType)
    {
        ...
        if (!is_null($vzType) && ($vzType > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $vzType when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHn., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($vzType) && ($vzType < -2147483648)) {
            throw new \InvalidArgumentException('invalid value for $vzType when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHn., must be bigger than or equal to -2147483648.');
        }
     ...
     * Sets soapCredential
     *
     * @param \OpenAPI\Client\Model\LabelHardwareNodeSshCredential|null $soapCredential soapCredential
     *
     * @return self
     */
    ...
    public function setIpAddress($ipAddress)
    {
        if (!is_null($ipAddress) && (mb_strlen($ipAddress) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $ipAddress when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHn., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($ipAddress) && (!preg_match("/(.*){0,2147483647}/", $ipAddress))) {
            throw new \InvalidArgumentException("invalid value for \$ipAddress when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHn., must conform to the pattern /(.*){0,2147483647}/.");
        }
    ...
    public function setPhysCpuNumber($physCpuNumber)
    {
        ...
        if (!is_null($physCpuNumber) && ($physCpuNumber > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $physCpuNumber when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHn., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($physCpuNumber) && ($physCpuNumber < -2147483648)) {
            throw new \InvalidArgumentException('invalid value for $physCpuNumber when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHn., must be bigger than or equal to -2147483648.');
        }
    ...
    public function setLoadMarkOffset($loadMarkOffset)
    {
        ...
        if (!is_null($loadMarkOffset) && ($loadMarkOffset > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $loadMarkOffset when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHn., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($loadMarkOffset) && ($loadMarkOffset < -2147483648)) {
            throw new \InvalidArgumentException('invalid value for $loadMarkOffset when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHn., must be bigger than or equal to -2147483648.');
        }
    ...
    public function setLabels($labels)
    {
        ...
        if (!is_null($labels) && (count($labels) > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $labels when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHn., number of items must be less than or equal to 2147483647.');
        }
    ...
    public function setCpuFreq($cpuFreq)
    {
        ...
        if (!is_null($cpuFreq) && ($cpuFreq > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $cpuFreq when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHn., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($cpuFreq) && ($cpuFreq < -2147483648)) {
            throw new \InvalidArgumentException('invalid value for $cpuFreq when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHn., must be bigger than or equal to -2147483648.');
        }
    ...
    public function setRegionGateNumber($regionGateNumber)
    {
        ...
        if (!is_null($regionGateNumber) && ($regionGateNumber > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $regionGateNumber when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHn., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($regionGateNumber) && ($regionGateNumber < -2147483648)) {
            throw new \InvalidArgumentException('invalid value for $regionGateNumber when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHn., must be bigger than or equal to -2147483648.');
        }
     ...
     * Gets vsVersion
     *
     * @return \OpenAPI\Client\Model\ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHnVsVersion|null
     */
     ...
     * Sets vsVersion
     *
     * @param \OpenAPI\Client\Model\ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHnVsVersion|null $vsVersion vsVersion
     *
     * @return self
     */
    ...
    public function setL2Ip($l2Ip)
    {
        if (!is_null($l2Ip) && (mb_strlen($l2Ip) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $l2Ip when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHn., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($l2Ip) && (!preg_match("/(.*){0,2147483647}/", $l2Ip))) {
            throw new \InvalidArgumentException("invalid value for \$l2Ip when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHn., must conform to the pattern /(.*){0,2147483647}/.");
        }
    ...
    public function setExternalIp($externalIp)
    {
        if (!is_null($externalIp) && (mb_strlen($externalIp) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $externalIp when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHn., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($externalIp) && (!preg_match("/(.*){0,2147483647}/", $externalIp))) {
            throw new \InvalidArgumentException("invalid value for \$externalIp when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHn., must conform to the pattern /(.*){0,2147483647}/.");
        }
    ...
    public function setSoapPort($soapPort)
    {
        ...
        if (!is_null($soapPort) && ($soapPort > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $soapPort when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHn., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($soapPort) && ($soapPort < -2147483648)) {
            throw new \InvalidArgumentException('invalid value for $soapPort when calling ComHivextApiServerEnvironmentResponseSoftwareNodeResponseSoftNodeHn., must be bigger than or equal to -2147483648.');
        }
